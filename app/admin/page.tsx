    ...
    <div className="space-y-8">
      <div className="bg-white rounded-lg shadow p-8">
        ...
        <div className="bg-blue-50 border border-blue-200 p-6 rounded">
          <h2 className="text-lg font-bold text-blue-900 mb-4">Sync NFL Scores</h2>
          <p className="text-sm text-blue-800 mb-4">
            Click below to fetch latest NFL scores and process eliminations/survivals for the current week.
          </p>
          <button
